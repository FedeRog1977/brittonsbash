...
import { MappedProjects, Project } from '../../../../utils/types';

export const useSport = (mappedProjects: MappedProjects) => {
  const summary: ColumnTableProps = {
    leftColumn: {
      entries: ['Total', '2025', '2024', '2023', '2022', '2021', '2020'],
    },
    rightColumns: [
      {
        title: 'Occurrences',
  ...
  const routes: ColumnTableProps = {
    leftColumn: {
      entries: ['Unique', 'Total', '2025', '2024', '2023', '2022', '2021', '2020'],
    },
    rightColumns: [
      {
        title: 'Islands',
        entries: [
          ...
          `${mappedProjects.islands.number[2025]}`,
      ...
      },
      {
        ...
        entries: [
          ...
          `${mappedProjects.munros.number[2025]}`,
      ...
      },
      {
        ...
        entries: [
          ...
          `${mappedProjects.munroTops.number[2025]}`,
      ...
      },
      {
        ...
        entries: [
          ...
          `${mappedProjects.corbetts.number[2025]}`,
      ...
      },
      {
        ...
        entries: [
          ...
          `${mappedProjects.corbettTops.number[2025]}`,
      ...
      },
      {
        ...
        entries: [
          ...
          `${mappedProjects.grahams.number[2025]}`,
      ...
      },
      {
        ...
        entries: [
          ...
          `${mappedProjects.subTwos.number[2025]}`,
      ...
      },
      {
        ...
        entries: [
          ...
          `${mappedProjects.donalds.number[2025]}`,
  ...
  const activities2025: ColumnTableProps = {
    leftColumn: {
      entries: mappedProjects.projects[2025].map(({ name }: Partial<Project>) => name),
    },
    rightColumns: [
      {
        title: 'Distance',
        entries: mappedProjects.projects[2025].map(({ distance }: Project) => toMiles(distance)),
      },
      {
        title: 'Elevation',
        entries: mappedProjects.projects[2025].map(({ elevation }: Project) => toFeet(elevation)),
      },
      {
        title: 'Time',
        entries: mappedProjects.projects[2025].map(({ time }: Project) => time),
      },
    ],
  };
  ...
  const activities2024: ColumnTableProps = {
    leftColumn: {
      entries: mappedProjects.projects[2024].map(({ name }: Partial<Project>) => name),
    },
    rightColumns: [
      {
        title: 'Distance',
  ...
  const activities2023: ColumnTableProps = {
    leftColumn: {
      entries: mappedProjects.projects[2023].map(({ name }: Partial<Project>) => name),
    },
    rightColumns: [
      {
        title: 'Distance',
  ...
  const activities2022: ColumnTableProps = {
    leftColumn: {
      entries: mappedProjects.projects[2022].map(({ name }: Partial<Project>) => name),
    },
    rightColumns: [
      {
        title: 'Distance',
  ...
  const activities2021: ColumnTableProps = {
    leftColumn: {
      entries: mappedProjects.projects[2021].map(({ name }: Partial<Project>) => name),
    },
    rightColumns: [
      {
        title: 'Distance',
  ...
  const activities2020: ColumnTableProps = {
    leftColumn: {
      entries: mappedProjects.projects[2020].map(({ name }: Partial<Project>) => name),
    },
    rightColumns: [
      {
        title: 'Distance',
  ...
  const [is2025, setIs2025] = useState(true);
  ...
  const handleActivities = (e: any) => {
    if (e.currentTarget.value === '2025') {
      setActivities(activities2025);
      setIs2025(true);
      setIs2024(false);
      setIs2023(false);
      setIs2022(false);
      setIs2021(false);
      setIs2020(false);
    } else if (e.currentTarget.value === '2024') {
